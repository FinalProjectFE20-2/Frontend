...
} from '../../store/selectors/categoriesSelectors.js';
import {
  fetchProductsByCategory,
  setProducts,
} from '../../store/action/categories/actionCategories.js';
...
export const SortingProducts = () => {
  ...
  useEffect(() => {
    const filterParam = `categories=${category.name}`;
